...
### Архитектура ядра
Stellar использует современное гибридное ядро, сочетающее:
- **Высокую производительность** монолитного ядра
- **Безопасность** микроядерной архитектуры
- **Поддержку мультиплатформенности** (Windows/Linux/macOS приложений)
...
│   │   ├── kernel.c           # Основной код ядра (ядро!)
...
│   ├── apps/                # Встроенные приложения(Допольниьельно)
│   │   ├── Notepad/         # Блокнот
│   │   │   ├── Notepad.cs
│   │   │   └── Notepad.axaml
