...
<div align="center">
  ...
  <h1 style="font-size: 10rem; font-weight: bold;">Stellar - Операционная Система Новых Возможностей</h1>
...
## Основные Разработчики и основатели Stellar & Creator IA 🖥️
...
- **Артём Принь** — back-end разработчик, AI-сервисы. Настраивает модели, API, серверную логику.
- **Диана Ермолина** — контент и UX, обучение AI. Отвечает за диалоги, сценарии, чтобы помощник говорил по-человечески.
- **Яромир Фролов** — тестировщик. Запускает программы, ловит баги, проверяет совместимость.
- **Алексей Буров** — аналитика и маркетинг. Опросы, переговоры со школами, цифры и финансы.
- **Кира Наймушина** — дизайнер презентаций, оформитель. Делает красивые слайды, визуал, оформление материалов.
- **Игорь Голубев** — ассистент проекта. Помогает с разными задачами, участвует в обсуждениях, выполняет поручения команды.
